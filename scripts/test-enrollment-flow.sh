...
echo -e "${BLUE}2️⃣ Generating device credentials...${NC}"
...
echo -e "${BLUE}4️⃣ Verifying certificate...${NC}"
...
echo -e "${BLUE}5️⃣ Checking DynamoDB (by device_id)...${NC}"
...
echo -e "${BLUE}6️⃣ Checking DynamoDB (via SerialIndex)...${NC}"
